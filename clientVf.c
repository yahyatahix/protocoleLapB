...
void main()
{
    ...
    printf("\n Connetion établie à l'aide de la trame non numéroté \n");
    trait(fdr, fdq);
...
/* fdr et fdq descripteurs reponse/question */
{
    ...
    while (1) {
        ...
        if (strcmp(rep, "10001\0") == 0){
            printf(" \n\n le serveur est Ready to Receive   \n");
        }
        
        
        printf("\n Instruction :\n");
        printf(" \n************** pour interrompre la connexion taper la trame non numéroté DISC de demande de la deconnexion : 01010011  **************\n");
        printf("\n\n Ou bien entrer les données en binaire à envoyer à l'aide du protocole lapB  :\n");
